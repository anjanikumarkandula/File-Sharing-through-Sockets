...
int main() {
    ...
    if(connection_count>=4 && connection_count<=6 ){
    printf("swicting to mirror 1\n");
    send(clientSocket,"9695",sizeof("9695"),0);
   }
   if(connection_count>=7 && connection_count<=9){
    printf("swicting to mirror 2\n");
    send(clientSocket,"9694",sizeof("9694"),0);
   }
   if(connection_count>10){
    if(connection_count%3==2){
     printf("swicting to mirror 1\n");   
     send(clientSocket,"9695",sizeof("9695"),0);
    }
    if(connection_count%3==3){
     printf("swicting to mirror 1\n");   
     send(clientSocket,"9694",sizeof("9694"),0);
    }
   }
